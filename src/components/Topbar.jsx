...
export default function Topbar() {
  return (
    <div className="bg-[#0f0e37] px-6 mr-8 ml-4 py-4 flex justify-between rounded-lg items-center">
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <input
            type="text"
            placeholder="Search..."
            className="px-4 py-2 pl-10 rounded-md bg-[#1c1b4b] text-white focus:outline-none"
          />
